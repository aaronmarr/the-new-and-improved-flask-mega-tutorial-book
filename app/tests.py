...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow_posts(self):
        ...
        p2 = Post(body="post from amy", author=u2, timestamp=now + timedelta(seconds=2))
        p3 = Post(body="post from dougie", author=u3, timestamp=now + timedelta(seconds=3))
        p4 = Post(body="post from orla", author=u4, timestamp=now + timedelta(seconds=4))
